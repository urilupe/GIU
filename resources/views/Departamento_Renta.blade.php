...
<div class="container mx-auto px-4 py-8">
    <h1 class="text-3xl font-bold text-gray-800 text-center mb-6">Departamento en Renta</h1>
            ...
            <div class="relative h-96 overflow-hidden">
                ...
                <div class="hidden duration-700 ease-in-out" data-carousel-item>
                    <div class="flex items-center justify-center w-full h-full">
                        <img 
                            src="{{ asset('images/DepartamentoRenta1.jpg') }}" 
                ...
                <div class="hidden duration-700 ease-in-out" data-carousel-item>
                    <div class="flex items-center justify-center w-full h-full">
                        <img 
                            src="{{ asset('images/DepartamentoRenta2.jpg') }}" 
                            class="max-w-full max-h-full object-contain" 
                            alt="Imagen 2"
                        >
                    </div>
                ...
                <div class="hidden duration-700 ease-in-out" data-carousel-item>
                    <div class="flex items-center justify-center w-full h-full">
                        <img 
                            src="{{ asset('images/DepartamentoRenta3.jpg') }}" 
                            class="max-w-full max-h-full object-contain" 
                            alt="Imagen 3"
                        >
                    </div>
...
<span class="inline-flex items-center justify-center w-10 h-10 rounded-full bg-white/80 group-hover:bg-white/90 group-focus:ring-2 group-focus:ring-black group-focus:outline-none">
    ...
    <span class="sr-only">Next</span>
        ...
        <div class="p-8">
            <h2 class="text-2xl font-semibold text-gray-800">Departamento en Renta</h2>
            <p class="text-gray-600">Ubicación: Washington, Estados Unidos</p>
            <p class="text-gray-600">2 recámaras, 1 baño, 90 m²</p>
            <p class="text-gray-900 font-bold text-xl">Precio: $10,000 MXN</p>

            <div class="mt-6">
                <h3 class="text-xl font-semibold text-gray-800">Descripción:</h3>
                <p class="text-gray-600 mt-2">
                    Moderno departamento ubicado en una zona estratégica de la ciudad, cerca de estaciones de metro, centros comerciales y restaurantes. Con 2 recámaras y 1 baño, el departamento está diseñado para ofrecer comodidad, seguridad y calidad de vida. Perfecto para solteros, parejas o pequeños grupos familiares.
                </p>
            </div>
