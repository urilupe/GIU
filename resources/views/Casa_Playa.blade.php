            ...
            <div class="relative h-96 overflow-hidden rounded-lg">
                ...
                <div class="hidden duration-700 ease-in-out" data-carousel-item>
                    <div class="absolute inset-0 flex items-center justify-center">
                        <img src="{{ asset('images/playa1.jpg') }}" class="w-full h-full object-cover" alt="Casa con Jardín - Imagen 1">
                    </div>
                </div>
                <!-- Item 2 -->
                <div class="hidden duration-700 ease-in-out" data-carousel-item>
                    <div class="absolute inset-0 flex items-center justify-center">
                        <img src="{{ asset('images/playa2.jpg') }}" class="w-full h-full object-cover" alt="Casa con Jardín - Imagen 2">
                    </div>
                </div>
                <!-- Item 3 -->
                <div class="hidden duration-700 ease-in-out" data-carousel-item>
                    <div class="absolute inset-0 flex items-center justify-center">
                        <img src="{{ asset('images/playa3.jpg') }}" class="w-full h-full object-cover" alt="Casa con Jardín - Imagen 3">
                    </div>
                </div>
            </div>
