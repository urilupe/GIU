...
<div id="casa-centro" class="property-item casas container mx-auto px-4 py-8">
    <h1 class="text-3xl font-bold text-gray-800 text-center mb-6">Detalles de la Bodega en Renta</h1>
            ...
            <div class="relative h-96 overflow-hidden">
                ...
                <div class="hidden duration-700 ease-in-out" data-carousel-item>
                    <div class="flex items-center justify-center w-full h-full">
                        <img 
                            src="{{ asset('images/BodegaRenta1.jpg') }}" 
                ...
                <div class="hidden duration-700 ease-in-out" data-carousel-item>
                    <div class="flex items-center justify-center w-full h-full">
                        <img 
                            src="{{ asset('images/BodegaRenta2.jpg') }}" 
                            class="max-w-full max-h-full object-contain" 
                            alt="Imagen 2"
                        >
                    </div>
                ...
                <div class="hidden duration-700 ease-in-out" data-carousel-item>
                    <div class="flex items-center justify-center w-full h-full">
                        <img 
                            src="{{ asset('images/BodegaRenta3.jpg') }}" 
                            class="max-w-full max-h-full object-contain" 
                            alt="Imagen 3"
                        >
                    </div>
...
<span class="inline-flex items-center justify-center w-10 h-10 rounded-full bg-white/80 group-hover:bg-white/90 group-focus:ring-2 group-focus:ring-black group-focus:outline-none">
    ...
    <span class="sr-only">Next</span>
        ...
        <div class="p-8">
            <h2 class="text-2xl font-semibold text-gray-800">Bodega en Renta</h2>
