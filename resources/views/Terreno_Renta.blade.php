            ...
            <div class="relative h-96 overflow-hidden">
                ...
                <div class="hidden duration-700 ease-in-out" data-carousel-item>
                    <div class="flex items-center justify-center w-full h-full">
                        <img 
                            src="{{ asset('images/TerrenoRenta1.jpg') }}" 
                ...
                <div class="hidden duration-700 ease-in-out" data-carousel-item>
                    <div class="flex items-center justify-center w-full h-full">
                        <img 
                            src="{{ asset('images/TerrenoRenta2.jpg') }}" 
                            class="max-w-full max-h-full object-contain" 
                            alt="Imagen 2"
                        >
                    </div>
                ...
                <div class="hidden duration-700 ease-in-out" data-carousel-item>
                    <div class="flex items-center justify-center w-full h-full">
                        <img 
                            src="{{ asset('images/TerrenoRenta3.jpg') }}" 
                            class="max-w-full max-h-full object-contain" 
                            alt="Imagen 3"
                        >
                    </div>
...
<span class="inline-flex items-center justify-center w-10 h-10 rounded-full bg-white/80 group-hover:bg-white/90 group-focus:ring-2 group-focus:ring-black group-focus:outline-none">
    ...
    <span class="sr-only">Next</span>
        ...
        <div class="p-8">
            <h2 class="text-2xl font-semibold text-gray-800">Terreno en Renta</h2>
            <p class="text-gray-600">Ubicación: Guadalajara, Jalisco</p>
            <p class="text-gray-900 font-bold text-xl">Precio: $40,000 MXN / mes</p>

            <div class="mt-6">
                <h3 class="text-xl font-semibold text-gray-800">Descripción:</h3>
                <p class="text-gray-600 mt-2">
                    Un terreno cerca de la ciudad, en el cual puedes guardar diferentes vehiculos o utilzarlo de almacen para objetos personales o de poco uso.               </p>
            </div>
