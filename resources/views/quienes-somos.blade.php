...
@section('contenido')
    <div class="max-w-6xl mx-auto p-6 bg-gray-100 rounded-lg shadow-lg flex flex-col md:flex-row items-center">
        ...
        <div class="md:w-1/2 md:pl-6 px-6">
            ...
            <p class="text-gray-700 mb-2 text-xl"><strong>Asesoría Personalizada:</strong> Te ayudamos en cada paso, asegurándonos de que tomes la mejor decisión.</p>
            <p class="text-gray-700 mb-2 text-xl"><strong>Variedad de Propiedades:</strong> Tenemos diferentes opciones para que elijas la que más te guste.</p>
            <p class="text-gray-700 text-xl"><strong>Compromiso y Confianza:</strong> Trabajamos para ofrecerte solo lo mejor y asegurarnos de que el proceso sea claro y transparente.</p>
        </div>
    </div>
@endsection
