...
<div class="flex items-center justify-center py-4 md:py-8 flex-wrap"> 
    <button id="btn_all" type="button" class="text-blue-700 hover:text-blue-700 border border-blue-600 bg-white hover:bg-blue-700 focus:ring-4 focus:outline-none focus:ring-blue-300 rounded-full text-xl font-medium px-5 py-2.5 text-center me-3 mb-3 dark:border-blue-500 dark:text-blue-500 dark:hover:text-white dark:hover:bg-blue-500 dark:bg-gray-900 dark:focus:ring-blue-800">Todas las categorías</button>
...
<div id="dropdownSearch" class="z-10 hidden bg-white rounded-lg shadow-sm w-60 dark:bg-gray-700">
    ...
    <ul class="h-48 px-3 pb-3 overflow-y-auto text-sm text-gray-700 dark:text-gray-200" aria-labelledby="dropdownSearchButton">
        ...
        <li>
          ...
          Metros²
          <div class="flex items-center p-2 rounded-sm hover:bg-gray-100 dark:hover:bg-gray-600">
            <input id="checkbox-m100" type="checkbox" value="100m" class="w-4 h-4 text-blue-600 bg-gray-100 border-gray-300 rounded-sm focus:ring-blue-500 dark:focus:ring-blue-600 focus:ring-2 dark:bg-gray-600 dark:border-gray-500">
            <label for="checkbox-m100" class="w-full ms-2 text-sm font-medium text-gray-900 dark:text-gray-300">100 m²</label>
          </div>
        </li>
        <li>
          <div class="flex items-center p-2 rounded-sm hover:bg-gray-100 dark:hover:bg-gray-600">
            <input id="checkbox-m150" type="checkbox" value="150m" class="w-4 h-4 text-blue-600 bg-gray-100 border-gray-300 rounded-sm focus:ring-blue-500 dark:focus:ring-blue-600 focus:ring-2 dark:bg-gray-600 dark:border-gray-500">
            <label for="checkbox-m150" class="w-full ms-2 text-sm font-medium text-gray-900 dark:text-gray-300">150 m²</label>
          </div>
        </li>
        <li>
          <div class="flex items-center p-2 rounded-sm hover:bg-gray-100 dark:hover:bg-gray-600">
            <input id="checkbox-m200" type="checkbox" value="200m" class="w-4 h-4 text-blue-600 bg-gray-100 border-gray-300 rounded-sm focus:ring-blue-500 dark:focus:ring-blue-600 focus:ring-2 dark:bg-gray-600 dark:border-gray-500">
            <label for="checkbox-m200" class="w-full ms-2 text-sm font-medium text-gray-900 dark:text-gray-300">200 m²</label>
          </div>
        </li>
      </ul>    
</div>
...
<div class="container mx-auto px-4 py-8">
    <h1 id="titulo" class="text-3xl font-bold text-center mb-6">En Renta</h1>
    ...
    <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
        ...
        <div class="producto border-2 property-item casas rounded-lg shadow-md overflow-hidden">
            ...
            <div class="p-4">
                <h2 class="text-xl font-semibold text-gray-800">Casa en la Playa</h2>
                <p class="text-xl text-gray-600">2 recámaras, 1 baño, 100 m²</p>
                <p class="text-xl text-gray-900 font-bold">$15,000 MXN / mes</p>
        ...
        <div class="producto border-2 property-item casas rounded-lg shadow-md overflow-hidden">
            ...
            <div class="p-4">
                <h2 class="text-xl font-semibold text-gray-800">Casa en Zona Residencial</h2>
                <p class="text-xl text-gray-600">3 recámaras, 2 baños, 150 m²</p>
                <p class="text-xl text-gray-900 font-bold">$22,000 MXN / mes</p>
        ...
        <div class="producto border-2  property-item casas rounded-lg shadow-md overflow-hidden">
            ...
            <div class="p-4">
                <h2 class="text-xl font-semibold text-gray-800">Casa con Jardín</h2>
                <p class="text-xl text-gray-600">4 recámaras, 3 baños, 200 m²</p>
                <p class="text-xl text-gray-900 font-bold">$25,000 MXN / mes</p>
                <a href="{{ url('Casa_Jardin') }}" class="block mt-4 text-blue-500 hover:underline">Ver detalles</a>
            </div>
        </div>

        <!-- Departamento 2 -->
        <div class="producto border-2 property-item departamentos rounded-lg shadow-md overflow-hidden">
            <img class="w-full h-56 object-cover" src="{{ asset('images/departamento2.jpg') }}" alt="Departamento">
            <div class="p-4">
                <h2 class="text-xl font-semibold text-gray-800">Departamento en Renta</h2>
                <p class="text-xl text-gray-600">3 recámaras, 2 baños, 120 m²</p>
                <p class="text-xl text-gray-900 font-bold">$20,000 MXN</p>
                <a href="{{ url('Departamento_Renta') }}" class="block mt-4 text-blue-500 hover:underline">Ver detalles</a>
            </div>
        </div>

        <!-- Locales 2 -->
        <div class="producto border-2 property-item locales rounded-lg shadow-md overflow-hidden">
            <img class="w-full h-56 object-cover" src="{{ asset('images/locales2.jpg') }}" alt="Local 2">
            <div class="p-4">
                <h2 class="text-xl font-semibold text-gray-800">Local en Renta</h2>
                <p class="text-xl text-gray-600">2 baños, 20 m²</p>
                <p class="text-xl text-gray-900 font-bold">50,000 MXN</p>
                <a href="{{ url('Local_Renta') }}" class="block mt-4 text-blue-500 hover:underline">Ver detalles</a>
            </div>
        </div>
        <!-- Terrenos 2 -->
        <div class="producto border-2 property-item terrenos rounded-lg shadow-md overflow-hidden">
            <img class="w-full h-56 object-cover" src="{{ asset('images/terreno2.jpg') }}" alt="Terreno2">
            <div class="p-4">
                <h2 class="text-xl font-semibold text-gray-800">Terreno en Renta</h2>
                <p class="text-xl text-gray-600">200 m²</p>
                <p class="text-xl text-gray-900 font-bold">$40,000 MXN</p>
                <a href="{{ url('Terreno_Renta') }}" class="block mt-4 text-blue-500 hover:underline">Ver detalles</a>
            </div>
        </div>

        <!-- Bodega -->
        <div class="producto border-2 property-item bodegas rounded-lg shadow-md overflow-hidden">
            <img class="w-full h-56 object-cover" src="{{ asset('images/bodega2.jpg') }}" alt="Bodega 2">
            <div class="p-4">
                <h2 class="text-xl font-semibold text-gray-800">Bodega en Renta</h2>
                <p class="text-xl text-gray-600">2 baños, 120 m²</p>
                <p class="text-xl text-gray-900 font-bold">$50,000 MXN</p>
                <a href="{{ url('Bodega_Renta') }}" class="block mt-4 text-blue-500 hover:underline">Ver detalles</a>
            </div>
        </div>
    </div>
</div>
