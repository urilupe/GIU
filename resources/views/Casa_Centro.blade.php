        ...
        <div id="carouselExampleControls" class="carousel slide" data-bs-ride="carousel">
            <div class="carousel-inner">
                <div class="carousel-item active">
                    <img src="{{ asset('images/centro1.jpg') }}" class="d-block w-100 h-96 object-cover" alt="Casa en Renta - Imagen 1">
                </div>
                <div class="carousel-item">
                    <img src="{{ asset('images/centro2.jpg') }}" class="d-block w-100 h-96 object-cover" alt="Casa en Renta - Imagen 2">
                </div>
                <div class="carousel-item">
                    <img src="{{ asset('images/centro3.jpg') }}" class="d-block w-100 h-96 object-cover" alt="Casa en Renta - Imagen 3">
                </div>
            </div>
